...
/**
 * Execute code before creating each table
 * 
 * @param array $event an array with two keys. One to tell if a table is being dropped or created and another for errors
 * @return bool
 */
...
/**
 * Execute code after creating each table
 * 
 * @param array $event an array with two keys. One to tell if a table is being dropped or created and another for errors
 * @return void
 */
