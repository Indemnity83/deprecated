		...
		<div class="col-md-12">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($roles as $role): ?>
					<tr>
						<td><?php echo $this->Html->link($role['Role']['title'], array('controller' => 'roles', 'action' => 'view', $role['Role']['slug'])); ?> </td>
						<td class="actions text-right">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $role['Role']['slug']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $role['Role']['slug']), array('escape' => false)); ?>
